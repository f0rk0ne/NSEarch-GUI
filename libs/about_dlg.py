...
class AbtDlg(QDialog):
  ...
  def initUi(self):
    ...
    grid_layout.addWidget(self.logo, 0, 1, 1, 4)
    grid_layout.addWidget(self.version_text, 1, 1, 1, 4)
    grid_layout.addWidget(self.author_label, 2, 1, 1, 1)
    grid_layout.addWidget(self.dots, 2, 2, 1, 1)
    grid_layout.addWidget(self.author_text, 2, 3, 1, 1)
    grid_layout.addWidget(self.mail_label, 3, 1, 1 ,1)
    grid_layout.addWidget(self.dots_2, 3, 2, 1, 1)
    grid_layout.addWidget(self.mail_text, 3, 3, 1, 1)
    grid_layout.addWidget(self.github_label, 4, 1, 1, 1)
    grid_layout.addWidget(self.dots_3, 4, 2, 1, 1)
    grid_layout.addWidget(self.github_text, 4, 3, 1, 1)
    grid_layout.addWidget(self.web_label, 5, 1, 1, 1)
    grid_layout.addWidget(self.dots_4, 5, 2, 1, 1)
    grid_layout.addWidget(self.web_text, 5, 3, 1, 1)
